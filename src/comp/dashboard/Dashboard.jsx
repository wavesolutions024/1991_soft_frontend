...
const Dashboard = () => {
  ...
  const getAllNotification = async () => {
    try {
      const response = await api.get("api/notification/getBirthNotify");
    ...
    <>
      {notificationpopup && (
        <div class="notification_section">
          <h1>
            Today's Birthdays{" "}
            <span onClick={() => setNotificationPopUp(false)}>
              {" "}
              <RxCross2 />{" "}
            </span>
          </h1>
      ...
      <div>
        ...
        <main className="dashboard">
          <header className="dashboard-header">
            <div className="notify" onClick={() => setNotificationPopUp(true)}>
              <div className="number">{notification?.length || 0}</div>
            ...
            <div className="card card-calendar">
              <div className="card-title">
                <div>
                  ...
                  <p>
                    {calendar.subtitle ||
                      "Client meetings, tasks, and deadlines"}
                  </p>
                </div>
          ...
          >
            ...
            >
              ...
              <div className="appointment-modal-list">
                {expandedAppointmentEvent.appointments.map(
                  (appointment, idx) => (
